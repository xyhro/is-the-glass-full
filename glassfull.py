...
driver = webdriver.Chrome(r'C:\Users\Aldus\PycharmProjects\untitled\chromedriver.exe',chrome_options = options)
...
#infotables = courses.find('table',class_='table table-striped')
#info = infotables.find_all('tbody')
#info1section = infotables.find_all('tr')[1]
#avalible = info1section.find_all('td')[14].text
#print(avalible.strip())